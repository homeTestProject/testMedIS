...
public class StockWatcher implements EntryPoint {
    ...
    RootPanel rp = RootPanel.get("passwdFieldContainer");
    if(rp == null)
    {
    	System.out.println("unable to get password field container instance");
    }
    else
    {
    	rp.add(pwdField);
    ...
    class MyHandler implements ClickHandler, KeyUpHandler {
      ...
      private void sendNameToServer() {
        ...
        textToServerLabel.setText(userId);
        serverResponseLabel.setText("");
        greetingService.greetServer(userId, userPwd, new AsyncCallback<String>() {
